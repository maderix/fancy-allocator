...
// Compile: g++ -O3 -pthread -o bench_tcmalloc_threads bench_tcmalloc_threads.cpp -ltcmalloc
// Usage: ./bench_tcmalloc_threads [max_threads]
#include <iostream>
#include <thread>
#include <vector>
#include <chrono>
...
int main(int argc, char* argv[]) {
    ...
    for (int t : thread_counts) {
        ...
        std::cout << "tcmalloc," << t << "," << elapsed << "," << ops
