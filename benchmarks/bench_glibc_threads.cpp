// glibc malloc - thread scaling benchmark
// Compile: g++ -O3 -pthread -o bench_glibc_threads bench_glibc_threads.cpp
// Usage: ./bench_glibc_threads [max_threads]
#include <iostream>
#include <thread>
#include <vector>
#include <chrono>
